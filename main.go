...
// initFlags parses verbosity level, and if a different logr should be used

var verbosityLevel = flag.Bool("v", false, "Set the verbosity to a higher level")
var extraVerbosityLevel = flag.Bool("vv", false, "Set the verbosity to a higher level")
var useZap = flag.Bool("zap", false, "Set the logger to zap")
